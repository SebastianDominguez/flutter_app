...
//import 'package:flutter_local_notifications/../../example/main.dart';
          ...
          child: Column(
            children: <Widget>[
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 8.0),
                    child: Text(
                        'Presiona algun boton para interactuar con las notificaciones'),
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Mostrar notificación',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                    'Mostrar notificación con descripción',
                    onPressed: () async {
                      await _showNotificationWithUpdatedChannelDescription();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Cancelar notificaciones',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                      buttonText:
                      'Programar notificación para que aparezca en 5 segundos, con sonido personalizado, color rojo, icono grande y LED roja',
                      onPressed: () async {
                        await _scheduleNotification();
                      }),
                  PaddedRaisedButton(
                    buttonText: 'Repetir notificación cada minuto',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                    'Repetir notificación todos los días a las 10 am',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                    'Repetir notificación todos los Miercoles a las 08 am',
                    onPressed: () async {
                      await _showWeeklyAtDayAndTime();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Mostrar notificación sin sonido',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText: 'Mostrar notificación con texto grande [Android]',
                    onPressed: () async {
                      await _showBigTextNotification();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Mostrar notificaión con mensaje [Android]',
                    onPressed: () async {
                      await _showInboxNotification();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Mostrar notificaciones agrupadas [Android]',
                    onPressed: () async {
                      await _showGroupedNotifications();
                    },
                  ),
                    PaddedRaisedButton(
                      buttonText: 'Mostrar notificación simulando un chat [Android]',
                      onPressed: () async {
                        await _showMessagingNotification();
                      },
                    ),
                  PaddedRaisedButton(
                    buttonText: 'Mostrar notificación que no se borra [Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                    'Mostrar notificación de progreso, se actualiza cada segundo [Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                    'Mostrar notificación de progreso indefinido [Android]',
                    onPressed: () async {
                      await _showIndeterminateProgressNotification();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Mostrar notificaciones pendientes',
                    onPressed: () async {
                      await _checkPendingNotificationRequests();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Cancelar todas las notificaciones',
                    onPressed: () async {
